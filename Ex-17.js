...
let guestList = ["nabeelah", "maryam", "jahanzaib", "alishba"];
let absentGuest = "maryam";
let newInvitee1_ = "maria";
let newInvitee2 = "Hadia";
let newInvitee3 = "Ali";
...
const indexToInsert = Math.floor(guestList.length / 2); // Insert at the middle index
